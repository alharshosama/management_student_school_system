...
class DeleteSchoolControl extends StatefulWidget {
   DeleteSchoolControl({Key? key, required this.itemId}) : super(key: key);
  final int itemId;

  @override
  State<DeleteSchoolControl> createState() => _DeleteSchoolControlState();
}

class _DeleteSchoolControlState extends State<DeleteSchoolControl> {
              ...
              children: [
                TextButton(
                  ...
                  try{
                    ...
                    var addRes = await SchoolControlRepository().delete(widget.itemId);
                    if(addRes>0 ){
                      setState(() {
                        loading =false;
                        isSuccess =true;
