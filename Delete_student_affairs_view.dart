...
class DeleteStudentAffairs extends StatefulWidget {
   DeleteStudentAffairs({Key? key, required this.itemId}) : super(key: key);
  final int itemId;

  @override
  State<DeleteStudentAffairs> createState() => _DeleteStudentAffairsState();
}

class _DeleteStudentAffairsState extends State<DeleteStudentAffairs> {
              ...
              children: [
                TextButton(
                  ...
                  try{
                    ...
                    var addRes = await StudentAffairsRepository().delete(widget.itemId);
                    if(addRes>0 ){
                      setState(() {
                        loading =false;
                        isSuccess =true;
