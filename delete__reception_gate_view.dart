...
class DeleteReceptionGate extends StatefulWidget {
   DeleteReceptionGate({Key? key, required this.itemId}) : super(key: key);
  final int itemId;

  @override
  State<DeleteReceptionGate> createState() => _DeleteReceptionGateState();
}

class _DeleteReceptionGateState extends State<DeleteReceptionGate> {
              ...
              children: [
                TextButton(
                  ...
                  try{
                    ...
                    var addRes = await ReceptionGateRepository().delete(widget.itemId);
                    if(addRes>0 ){
                      setState(() {
                        loading =false;
                        isSuccess =true;
