...
class DeleteSchoolWarehouse extends StatefulWidget {
   DeleteSchoolWarehouse({Key? key, required this.itemId}) : super(key: key);
  final int itemId;

  @override
  State<DeleteSchoolWarehouse> createState() => _DeleteSchoolWarehouseState();
}

class _DeleteSchoolWarehouseState extends State<DeleteSchoolWarehouse> {
              ...
              children: [
                TextButton(
                  ...
                  try{
                    ...
                    var addRes = await SchoolWarehouseRepository().delete(widget.itemId);
                    if(addRes>0 ){
                      setState(() {
                        loading =false;
                        isSuccess =true;
