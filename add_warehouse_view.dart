...
class AddSchoolWarehouse extends StatefulWidget {
  const AddSchoolWarehouse({Key? key}) : super(key: key);

  @override
  State<AddSchoolWarehouse> createState() => _AddSchoolWarehouseState();
}

class _AddSchoolWarehouseState extends State<AddSchoolWarehouse> {
  bool loading = false;
  bool isError = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppbar("Add SchoolWarehouse"),
      body: Form(
                      ...
                      loading ?CircularProgressIndicator() : TextButton(
                        ...
                        if(formkey.currentState!.validate()){
                          try{
                            ...
                            var addRes = await SchoolWarehouseRepository().add(data);
                            if(addRes>0 ){
                              setState(() {
                                loading =false;
                                isSuccess =true;
