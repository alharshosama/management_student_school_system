...
class DeltetPersonnel extends StatefulWidget {
   DeltetPersonnel({Key? key, required this.itemId}) : super(key: key);
  final int itemId;

  @override
  State<DeltetPersonnel> createState() => _DeltetPersonnelState();
}

class _DeltetPersonnelState extends State<DeltetPersonnel> {
              ...
              children: [
                TextButton(
                  ...
                  try{
                    ...
                    var addRes = await PersonnelRepository().delete(widget.itemId);
                    if(addRes>0 ){
                      setState(() {
                        loading =false;
                        isSuccess =true;
