...
class DeleteManagerAccount extends StatefulWidget {
   DeleteManagerAccount({Key? key, required this.itemId}) : super(key: key);
  final int itemId;

  @override
  State<DeleteManagerAccount> createState() => _DeleteManagerAccountState();
}

class _DeleteManagerAccountState extends State<DeleteManagerAccount> {
              ...
              children: [
                TextButton(
                  ...
                  try{
                    ...
                    var addRes = await AccountManagementRepository().delete(widget.itemId);
                    if(addRes>0 ){
                      setState(() {
                        loading =false;
                        isSuccess =true;
