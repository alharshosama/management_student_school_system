...
class DeleteEvents extends StatefulWidget {
   DeleteEvents({Key? key, required this.itemId}) : super(key: key);
  final int itemId;

  @override
  State<DeleteEvents> createState() => _DeleteEventsState();
}

class _DeleteEventsState extends State<DeleteEvents> {
              ...
              children: [
                TextButton(
                  ...
                  try{
                    ...
                    var addRes = await EventsRepository().delete(widget.itemId);
                    if(addRes>0 ){
                      setState(() {
                        loading =false;
                        isSuccess =true;
