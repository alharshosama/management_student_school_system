...
class DeleteBus extends StatefulWidget {
   DeleteBus({Key? key, required this.itemId}) : super(key: key);
  final int itemId;

  @override
  State<DeleteBus> createState() => _DeleteBusState();
}

class _DeleteBusState extends State<DeleteBus> {
              ...
              children: [
                TextButton(
                  ...
                  try{
                    ...
                    var addRes = await SchoolBusRepository().delete(widget.itemId);
                    if(addRes>0 ){
                      setState(() {
                        loading =false;
                        isSuccess =true;
