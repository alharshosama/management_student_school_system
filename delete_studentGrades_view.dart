...
class DeleteStudentGrades extends StatefulWidget {
   DeleteStudentGrades({Key? key, required this.itemId}) : super(key: key);
  final int itemId;

  @override
  State<DeleteStudentGrades> createState() => _DeleteStudentGradesState();
}

class _DeleteStudentGradesState extends State<DeleteStudentGrades> {
              ...
              children: [
                TextButton(
                  ...
                  try{
                    ...
                    var addRes = await StudentGradesRepository().delete(widget.itemId);
                    if(addRes>0 ){
                      setState(() {
                        loading =false;
                        isSuccess =true;
