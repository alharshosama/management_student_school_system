...
class DeleteCourses extends StatefulWidget {
  const DeleteCourses({Key? key, required this.itemId}) : super(key: key);
  final int itemId;

  @override
  State<DeleteCourses> createState() => _DeleteCoursesState();
}
              ...
              children: [
                TextButton(
                  ...
                  try{
                    ...
                    var addRes = await CoursesRepository().delete(widget.itemId);
                    if(addRes>0 ){
                      setState(() {
                        loading =false;
                        isSuccess =true;
